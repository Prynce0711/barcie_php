        ...
        <div class="content-section">
            ...
            <div class="info-card">
                ...
                <div class="info-row">
                    ...
                    <span class="info-value"><strong><?php echo htmlspecialchars($pencil_booking['receipt_no']); ?></strong></span>
                </div>
                ...
                <div class="info-row">
                    ...
                    <span class="info-value"><?php echo date('F j, Y g:i A', strtotime($pencil_booking['checkin'])); ?></span>
                </div>
                
                <div class="info-row">
                    <span class="info-label">Check-out:</span>
                    <span class="info-value"><?php echo date('F j, Y g:i A', strtotime($pencil_booking['checkout'])); ?></span>
                </div>
                
                <div class="info-row">
                    <span class="info-label">Number of Occupants:</span>
                    <span class="info-value"><?php echo htmlspecialchars($pencil_booking['occupants']); ?> person<?php echo $pencil_booking['occupants'] != 1 ? 's' : ''; ?></span>
                </div>
                
                <div class="info-row">
                    <span class="info-label">Estimated Price:</span>
                    <span class="info-value"><strong>₱<?php echo number_format($pencil_booking['total_price'], 2); ?></strong></span>
                </div>
            ...
            <div class="text-center">
                <form id="conversionForm" method="POST" action="Guest.php#booking">
                    ...
                    <input type="hidden" name="guest_name" value="<?php echo htmlspecialchars($pencil_booking['guest_name']); ?>">
                    <input type="hidden" name="email" value="<?php echo htmlspecialchars($pencil_booking['email']); ?>">
                    <input type="hidden" name="contact_number" value="<?php echo htmlspecialchars($pencil_booking['contact_number']); ?>">
                    ...
                    <input type="hidden" name="company" value="<?php echo htmlspecialchars($pencil_booking['company'] ?? ''); ?>">
                    <input type="hidden" name="company_contact" value="<?php echo htmlspecialchars($pencil_booking['company_contact'] ?? ''); ?>">
