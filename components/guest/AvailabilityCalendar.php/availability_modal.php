...
<div class="modal fade" id="roomCalendarModal" tabindex="-1" aria-labelledby="roomCalendarModalLabel"
  aria-hidden="true">
    ...
    <div class="modal-content">
      <div class="modal-header">
        ...
        <div class="btn-group btn-group-sm ms-3 me-2" role="group" aria-label="Modal navigation">
          ...
          <button type="button" class="btn btn-outline-secondary" title="Today"
            onclick="if(window.roomCalendarToday) roomCalendarToday();">Today</button>
          <button type="button" class="btn btn-outline-secondary" title="Next"
            onclick="if(window.roomCalendarNext) roomCalendarNext();">
      ...
      <div class="modal-body">
        <div id="roomCalendarInner" style="min-height: 220px; position:relative;">
          <div id="roomCalendarLegend"
            style="margin-bottom:12px;display:flex;gap:12px;align-items:center;padding:8px;background:#f8f9fa;border-radius:6px;flex-wrap:wrap;">
          ...
          <div id="roomCalendarLoading"
            style="position:absolute;left:0;right:0;top:0;bottom:0;display:flex;align-items:center;justify-content:center;background:rgba(255,255,255,0.85);z-index:50;">
        ...
        <style>
          ...
          #roomCalendarMount .fc-col-header-cell,
          #roomCalendarMount .fc-col-header-cell .fc-col-header-cell-cushion {
            color: #ffffff !important;
          }

          #roomCalendarMount .fc .fc-event,
          #roomCalendarMount .fc .fc-event-main,
          #roomCalendarMount .fc .fc-event-title {
            color: #ffffff !important;
          }
        </style>
      </div>
