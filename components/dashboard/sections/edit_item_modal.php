            ...
            <div class="card-body">
              <div class="row">
                ...
                <div class="col-md-4 mb-3">
                  ...
                  <input type="text" class="form-control" name="room_number" id="editRoomNumber" placeholder="e.g., 101">
                </div>
                ...
                <div class="col-12 mb-3">
                  ...
                  <textarea class="form-control" name="description" id="editDescription" rows="3" placeholder="Enter a detailed description..."></textarea>
                </div>
              </div>
            </div>
          </div>
