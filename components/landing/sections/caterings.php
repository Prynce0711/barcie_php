<?php
// Partner Caterings section partial
?>
<section id="caterings" class="partners-section section-padding">
  <div class="container">
    <h2 class="section-title text-center mb-5">Partner Caterings</h2>

    <div class="row partners-grid g-4">
      <!-- ALMA SAN PEDRO CATERING & SERVICES -->
      ...
      <!-- LEONY'S EVENT STYLING AND CATERING SERVICES -->
      <div class="col-12 col-sm-6 col-md-4 col-lg-3">
        <div class="card glass-card h-100">
          <div class="partner-logo-wrap">
      ...
      <!-- FAMILY AFFAIR EVENT SPECIALIST(FAES) -->
      <div class="col-12 col-sm-6 col-md-4 col-lg-3">
        <div class="card glass-card h-100">
          <div class="partner-logo-wrap">
