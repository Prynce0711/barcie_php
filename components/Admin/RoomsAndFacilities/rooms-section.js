    ...
    function (e) {
      ...
      if (cancel) {
        ...
        const editButton = document.querySelector(
          `.edit-toggle-btn[data-item-id="${itemId}"]`,
        );
...
function updateItemCounts() {
  ...
  const countAll =
    ...
    document.querySelector('[data-type="all"] .badge');
  const countRooms =
    document.getElementById("count-rooms") ||
    document.querySelector('[data-type="room"] .badge');
  const countFacilities =
    document.getElementById("count-facilities") ||
    document.querySelector('[data-type="facility"] .badge');
...
function updateVisibleCounts() {
  const visibleItems = document.querySelectorAll(
    '.item-card[style*="block"], .item-card:not([style*="none"])',
  );
  const visibleRooms = document.querySelectorAll(
    '.item-card[data-type="room"]:not([style*="none"])',
  );
  const visibleFacilities = document.querySelectorAll(
    '.item-card[data-type="facility"]:not([style*="none"])',
  );
