  ...
  <!-- App JS -->
  <script src="src/assets/js/guest/guest-bootstrap.js"></script>
  <script src="src/assets/js/guest/guest-inline.js" defer></script>
  <script src="src/assets/js/verify-structure.js" defer></script>
  <script src="src/assets/js/verify-components.js" defer></script>
