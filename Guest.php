<?php
session_start();
include __DIR__ . '/src/database/db_connect.php';
...
<html lang="en">
<head>
  <?php include __DIR__ . '/src/components/guest/head.php'; ?>
  <script>
...
<body>
  ...
  <!-- Sidebar -->
  <?php include __DIR__ . '/src/components/guest/sidebar.php'; ?>

  <!-- Main Content -->
  <main class="main-content">
    <div class="container-fluid">
  <?php include __DIR__ . '/src/components/guest/sections/overview.php'; ?>
  <?php include __DIR__ . '/src/components/guest/sections/availability.php'; ?>
  <?php include __DIR__ . '/src/components/guest/sections/rooms.php'; ?>
  <?php include __DIR__ . '/src/components/guest/sections/booking.php'; ?>
  <?php include __DIR__ . '/src/components/guest/sections/feedback.php'; ?>
    </div>
  </main>

  <!-- Chatbot -->
  <?php include __DIR__ . '/src/components/guest/sections/chatbot.php'; ?>

  <!-- Footer -->
  <?php include __DIR__ . '/src/components/guest/footer.php'; ?>
</body>
</html>