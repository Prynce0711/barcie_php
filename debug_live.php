    ...
    ?>">
        ...
        if ($vendor_exists && file_exists($env_file)) {
            ...
            try {
                ...
                $smtp_user = getenv('SMTP_USERNAME') ?: getenv('SMTP_USER') ?: ($_ENV['SMTP_USERNAME'] ?? $_ENV['SMTP_USER'] ?? 'NOT SET');
                ...
                $smtp_password = getenv('SMTP_PASSWORD') ?: getenv('SMTP_PASS') ?: ($_ENV['SMTP_PASSWORD'] ?? $_ENV['SMTP_PASS'] ?? '');
